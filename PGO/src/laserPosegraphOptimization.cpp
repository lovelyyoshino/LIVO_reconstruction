...
{
    // parse pointclouds
    int historyKeyframeSearchNum = 55; // enough. ex. [-25, 25] covers submap length of 50x1 = 50m if every kf gap is 1m
    ...
    loopFindNearKeyframesCloud_jxx(cureKeyframeCloud, _curr_kf_idx,20, _curr_kf_idx);
